...
this.addHotetModalityLogic(hotelModality); // se añade la modalidad de hotel a la logica del programa
	}

	public void addHotetModalityLogic (HotelModality hotelModality) { // metodo para insertar solo de forma logica
