...
public class HoursKilometers extends TransportModality {
    ...
    public void actualizarCampos(Contract contract, String typeOfModality, ArrayList<Vehicle> vehicles,
                                    String typeTransportModality, double costKilometersRout, double costHours, double costKilometersRoutAdditionals,
                                    double costHoursAdditionals) { // Metodo para actualizar los atributos de la clase
