...
public interface EstablishedRouteDAOInterface extends DAO <EstablishedRoute> {
	public List<EstablishedRoute> selectIntoCarrierContract (CarrierContract carrierContract) throws SQLException; // Metodo para obtener todas las modalidades de tranposrte tipo recorridos establecidos de un contrato con transportista especifico
