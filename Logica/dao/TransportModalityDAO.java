...
public class TransportModalityDAO implements TransportModalityDAOInterface{
	...
	@Override
	public List<TransportModality> selectIntoCarrierContract(int idCarrierContract) throws SQLException {
		...
		listTransportModality.addAll(CostKilometersDAO.getInstancie().selectIntoCarrierContract(idCarrierContract)); // se añade la lista de modalidades de transporte de tipo costo por kilometraje
		listTransportModality.addAll(EstablishedRouteDAO.getInstancie().selectIntoCarrierContract(idCarrierContract)); // se añade la lista de modalidades de transporte de tipo recorrido establecido
		listTransportModality.addAll(HoursKilometersDAO.getInstancie().selectIntoCarrierContract(idCarrierContract)); // se añade la lista de modalidades de transporte de tipo horas por kilometraje
