...
public class FrameGerenteCreacionContratoAlojamiento extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrameGerenteCreacionContratoAlojamiento frame = new FrameGerenteCreacionContratoAlojamiento();
	 ...
	 * Create the frame.
	 */
	public FrameGerenteCreacionContratoAlojamiento() {
		setUndecorated(true);
		...
		JLabel lblAccommodationContract = new JLabel("ACCOMMODATION CONTRACT");
		lblAccommodationContract.setFont(new Font("Arial Black", Font.PLAIN, 19));
		lblAccommodationContract.setBounds(27, 11, 331, 30);
		panel.add(lblAccommodationContract);
