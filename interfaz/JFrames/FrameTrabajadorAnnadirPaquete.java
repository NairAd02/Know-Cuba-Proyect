...
public class FrameTrabajadorAnnadirPaquete extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrameTrabajadorAnnadirPaquete frame = new FrameTrabajadorAnnadirPaquete();
	 ...
	 * Create the frame.
	 */
	public FrameTrabajadorAnnadirPaquete() {
		setUndecorated(true);
		...
		lblModalities.setBounds(32, 11, 151, 30);
		...
		lblNewLabel.setIcon(new ImageIcon(FrameTrabajadorAnnadirPaquete.class.getResource("/images/hotel1.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(FrameTrabajadorAnnadirPaquete.class.getResource("/images/carro3.png")));
		...
		lblNewLabel_1_1.setIcon(new ImageIcon(FrameTrabajadorAnnadirPaquete.class.getResource("/images/actividad4.png")));
		...
		JLabel lblReserve = new JLabel("CREATE");
