...
public class PanelTrabajadorModalidadAlojamiento extends JPanel {
	 ...
	 * Create the panel.
	 */
	public PanelTrabajadorModalidadAlojamiento() {
		setLayout(null);
		...
		lblAtras.setIcon(new ImageIcon(PanelTrabajadorModalidadAlojamiento.class.getResource("/images/flecha.png")));
