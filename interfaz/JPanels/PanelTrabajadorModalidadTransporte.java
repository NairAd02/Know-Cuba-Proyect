...
public class PanelTrabajadorModalidadTransporte extends JPanel {
	 ...
	 * Create the panel.
	 */
	public PanelTrabajadorModalidadTransporte() {
		setLayout(null);
		...
		lblAtras.setIcon(new ImageIcon(PanelTrabajadorModalidadTransporte.class.getResource("/images/flecha.png")));
